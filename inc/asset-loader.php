...
namespace AlstradocsBlocksBoilerplatePlugin\AssetLoader;
 ...
 * @return void;
 */
function registerAsset(string $manifestPath, string $targetAsset, array $options = [], $in_footer = true) : void
{
    $defaults = [
        'transformDevURI' => [],
        'scripts' => [],
 ...
 * @return void;
 */
function enqueueAsset(string $manifestPath, string $targetAsset, array $options = [], $in_footer = true) : void
{
    registerAsset($manifestPath, $targetAsset, $options, $in_footer);
